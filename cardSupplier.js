function allCards(){
    ...
    //Lesson 14,
    {front:"Er ist gross", back:"Il est grand"},
    {front:"Er ist klein", back:"Il est petit"},
    {front:"Sie ist ein Meter achtzig gross", back:"Elle mesure 1.80m"},
    {front:"Er ist schlank", back:"Il est mince"},
    {front:"Er ist dick", back:"Il est gros"},
    {front:"Sie wiegt circa siebzig Kilo", back:"Elle pèse environs 70kg"},
    {front:"Er is kahl", back:"Il est chauve"},
    {front:"Er is braun", back:"Il est brun"},
    {front:"Er is rothaarig", back:"Il est roux"},
    {front:"Sie hat kurzes Haar", back:"Elle a les cheveux courts"},
    {front:"Sie hat glattes Haar", back:"Elle a les cheveux raides"},
    {front:"Er hat lockiges Haar", back:"Il a les cheveux bouclés"},
    {front:"Sie hat blaue Augen", back:"Elle a les yeux bleus"},
    {front:"Er trägt einen Schnurrbart", back:"Il a une moustache"},
    {front:"Er trägt einen Bart", back:"Il a une barbe"},
    {front:"Sie hat Sommersprossen", back:"Elle a des taches de rousseur"},
    {front:"Sie trägt eine Brille", back:"Elle porte des lunettes"},
    {front:"Sie trägt Schmuck", back:"Elle porte des bijoux"},
